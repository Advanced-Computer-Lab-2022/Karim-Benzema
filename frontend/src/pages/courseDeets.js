...
console.log(itid)
const onButtonClick = () => {
    fetch('/api/email/'+itid, {
        method: 'POST',
        body: JSON.stringify({itid:itid}),
        headers: {
...
const handleSubmit4 = async(e) => {  
    e.preventDefault();
    const inputVal= {itid:itid,id:id,reviews:review2}
    if (review2!==''){ 
   ...
   // setCourses(json.courses);
    ...
    return (
            ...
            &nbsp;&nbsp;
                ...
                <form className="bottom_container2" >
         < button className='green_btn'  style={{display:prog}}  onClick={onButtonClick}>
                  Download Certificate
                </button>
                </form>
        <form className='bottom_container2' onSubmit={handleRefund}>
