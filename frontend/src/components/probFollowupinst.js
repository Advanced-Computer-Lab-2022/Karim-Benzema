...
const Probfollowupinst = ({problem}) => {
    ...
    const handleSubmit = async(e) => {  
        ...
        if ((followup!=='' )&&(resolved!=='')){ 
            const response = await fetch('/api/admin/followupINST/'+problem._id, {
                method: 'PATCH',
...
export default Probfollowupinst;