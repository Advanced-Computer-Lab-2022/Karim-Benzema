...
import SelectCountriesInst from './components/selectCountriesInst';
...
import AddEmailct from './components/addEmailct';
function App() {
    ...
    <div className="App">
      ...
      <div className= "pages">
        <Routes>
          ...
          <Route path="/viewproblems"element={<ViewProblems/>}/>
          <Route path="/profilect"element={<CtProfile/>}/>
          <Route path="/addemail"element={<AddEmailct/>}/>
